...
//	  		if (USBgg_DataReady){}
//	  		    {
//	  		        USB_DataReady = 0; // Clear flag
//
//	  		        // Example: send back what we received
//	  		        CDC_Transmit_FS(USB_RxBuffer, USB_RxLength);
//
//	  		        // Or process it as a string
//	  		        USB_RxBuffer[USB_RxLength] = '\0';
//
//	  		      SSD1306_Clear();
//	  		                  SSD1306_GotoXY(2, 10);
//	  		                  SSD1306_Puts(USB_RxBuffer, &Font_7x10, White);
//	  		                  SSD1306_UpdateScreen();
//
//	  		    }
    /* USER CODE END WHILE */
