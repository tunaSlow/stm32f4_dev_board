...
#include "stm32f4xx_hal.h" // Needed for the I2C type definition
// This tells other files hi2c2 exists in main.c
...
#define SSD1306_WIDTH           130    // OLED width
#define SSD1306_HEIGHT          64     // OLED height
