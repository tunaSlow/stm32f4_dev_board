...
C_SRCS += \
../Display_Driver/lvgl/src/lv_init.c 

OBJS += \
./Display_Driver/lvgl/src/lv_init.o 

C_DEPS += \
./Display_Driver/lvgl/src/lv_init.d 


# Each subdirectory must supply rules for building sources it contributes
Display_Driver/lvgl/src/%.o Display_Driver/lvgl/src/%.su Display_Driver/lvgl/src/%.cyclo: ../Display_Driver/lvgl/src/%.c Display_Driver/lvgl/src/subdir.mk
...
clean: clean-Display_Driver-2f-lvgl-2f-src

clean-Display_Driver-2f-lvgl-2f-src:
	-$(RM) ./Display_Driver/lvgl/src/lv_init.cyclo ./Display_Driver/lvgl/src/lv_init.d ./Display_Driver/lvgl/src/lv_init.o ./Display_Driver/lvgl/src/lv_init.su

.PHONY: clean-Display_Driver-2f-lvgl-2f-src
